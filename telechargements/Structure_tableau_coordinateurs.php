...
if ($i==0) echo "<br><br>Il n'existe actuellement aucun coordinateur pour votre structure."; 

//Entête de tableau
if ($i<>0)
{
	?>
<br><br><p class="sous-sous-titre">Voici la liste des coordinateurs pour votre structure.</p>
